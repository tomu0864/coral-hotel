...
(function ($) {
    ...
    $.fn.FancyFileUpload = function (options) {
        ...
        var AddFile = function (uploads, e, data) {
            var fileInputId = data.fileInput.prop("name");
            // Check if the file input ID matches the expected value
            if (data.fileInput.prop("name") === "single_image") {
                // Clear the uploads container for 'fancy-file-upload-main'
                uploads.empty();
            }

            var inforow = $(
                '<tr><td class="ff_fileupload_preview"> ... </td></tr>'
            );
