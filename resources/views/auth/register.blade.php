                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 ">
                                            <div class="form-group">
                                                ...
                                                is-invalid  @enderror" value="{{old('name')}}" required data-error="Please enter your Username" placeholder="Username">
                                                @error('name')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                is-invalid  @enderror" value="{{old('email')}}" required data-error="Please enter email" placeholder="Email">
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                is-invalid  @enderror" required data-error="Please enter password" placeholder="Password">
                                                @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
