  ...
  <div class="container">
    <div class="main-body">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <form action="{{ route('faq.update', $faq->id) }}" id="myForm" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-9 text-secondary">
                      <textarea name="answer" rows="10" class="form-control">{{ old('answer' , $faq->answer) }}</textarea>
                    </div>
                  </div>
