  ...
  <div class="container">
    <div class="main-body">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <form action="{{ route('testimonial.update', $testimonial->id) }}" id="myForm" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-9 text-secondary">
                      <input type="text" name="city" value="{{ old('city', $testimonial->city) }}"  class="form-control"/>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="form-group col-sm-9 text-secondary">
                      <textarea name="message" class="form-control" rows="3" placeholder="Message...">{{ old('city', $testimonial->message) }}</textarea>
                    </div>
                  </div>
