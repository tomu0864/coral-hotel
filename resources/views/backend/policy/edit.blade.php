        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body p-4">
              <h5 class="mb-4">Edit Policy
              </h5>
              <form action="{{ route('policy.update', $policy->id) }}" method="post" class="row g-3">
                @csrf
                @method('PAtCH')
                ...
                <div class="col-md-12">
                  ...
                  <textarea class="form-control @error('content') in-invalid @enderror" 
                            name="content" id="myeditorinstance" rows="3">{!! old('content', $policy->content) !!}</textarea>
                            @error('content')
