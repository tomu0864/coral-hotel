			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent1">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"> <a class="nav-link active" aria-current="page" href="{{ route('home') }}"><i class='bx bx-home-alt me-1'></i>Home</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<p>USER DOES NOT HAVE THE RIGHT PERMISSION</p>
