            ...
            <div class="col-lg-4">
                <div class="room-details-side">
                    <div class="side-bar-form">
                        <h3>Booking Sheet </h3>
                        {{-- T0 Show Error Message --}}
                        <div id="error-message-container">
                            <i id="error-message-icon" class="bx bx-error-circle"></i>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <input type="text" name="check_in" id="check_in" class="form-control dt_picker" 
                                          value="{{ date('Y-m-d', strtotime($checkIn))}}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <input type="text" name="check_out" id="check_out" class="form-control dt_picker" 
                                          value="{{ date('Y-m-d', strtotime($checkOut))}}"
                                          autocomplete="off" placeholder="yyyy-mm-dd" required>
                                          <span class="input-group-addon"></span>
                                        </div>
                                        <i class='bx bxs-calendar'></i>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="person" id="nmbr_person">
                                            @for ($i = 1; $i <= 4; $i++)
                                            <option {{ $person == $i ? 'selected' : ''}} value="0{{ $i }}">0{{ $i }}</option>
                                            @endfor
